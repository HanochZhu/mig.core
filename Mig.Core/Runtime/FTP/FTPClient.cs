...
namespace Mig.Core
{
    public class FTPClient
    {
        ...
        public static bool MakeDir(string ftpDirPath)
        {
            try
            {
                if (CheckFolderExists(ftpDirPath))
                {
                    Debug.Log($"{ftpDirPath} has already exit");
                    return true;
                }
                Debug.Log($"[Mig::FTPClient] ready to mkdir {ftpDirPath}");
            ...
            {
                Debug.LogError($"因 {ex.Message},无法下载");
                return false;
            }
        }

        public static bool CheckFolderExists(string ftpDirPath)
        {
            ...
            catch (WebException ex)
            {
                ...
                {
                    throw new Exception($"Error checking folder: {ex.Message}");
                }
            }
        }
        /// <summary>
